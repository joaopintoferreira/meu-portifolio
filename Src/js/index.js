/*
        ...
        -passo 1 - dae um jeito de pegar os elementos que representam as abas no HTML
...
function mostrarInformacoesDaAba(aba){
     ...
     const informacaoASeMostrada = document.getElementById(idDoElementoDeInformacoesDaAba)
     informacaoASeMostrada.classList.add("selecionado")
}
